function CursorBomb(a) {
  var b = this;
  (b.sliderId = "drop-nft-area"),
    (b.color = "#fff"),
    (b.hoverColor = "#88f"),
    (b.width = 0),
    (b.height = 20),
...
(cbBomb.prototype.move = function () {
  var a = this.cb,
    b = this;
  ...
  (CursorBomb.prototype.Bomb = cbBomb),
  (CursorBomb.prototype.swapList = function (a, b, c) {
    var d = this;
    a == null
      ? (a = new d.Bomb(d))
      : b.first == a
  ...
  (CursorBomb.prototype.parseColor = function (a) {
    var b,
      a = a.replace(" ", "");
  ...
  (CursorBomb.prototype.loadingStep = function () {
    var a = this;
    a.imagesLoaded++;
  ...
  (CursorBomb.prototype.$ = function (a, b, c) {
    var d = this;
    if (a[0] == ".") {
      var e = a.substr(1);
      b || (b = d.$$children);
  ...
  (CursorBomb.prototype.nextFrame = function () {
    var a = this;
  ...
  (CursorBomb.prototype.nextSlide = function (a) {
    var b = this;
  ...
  (CursorBomb.prototype.drawBombs = function () {
    var a = this,
  ...
  (CursorBomb.prototype.getPixelFromImageData = function (a, b, c) {
    var d = this,
      e = [];
  ...
  (CursorBomb.prototype.init = function (a) {
    var b = this;
    if (b.imgs.length > 0) {
  ...
  (CursorBomb.prototype.getCw = function () {
    var a = this;
    return Math.min(
  ...
  (CursorBomb.prototype.getCh = function () {
    var a = this;
    return Math.min(
  ...
  (CursorBomb.prototype.resize = function () {
    var a = this;
    (a.cw = a.getCw()),
      (a.ch = a.getCh()),
      (a.$canv.width = a.cw),
  ...
  (CursorBomb.prototype.setColor = function (a) {
    var b = this;
    b.colorArr = b.parseColor(a);
  }),
  (CursorBomb.prototype.setHoverColor = function (a) {
    var b = this;
    b.hoverColorArr = b.parseColor(a);
  }),
  (CursorBomb.prototype.requestAnimationFrame = function (a) {
    var b = this,
      c =
